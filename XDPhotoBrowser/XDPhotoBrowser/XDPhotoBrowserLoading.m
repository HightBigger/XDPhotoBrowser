...
static CGFloat lineWidth = 3;

@interface XDPhotoBrowserLoading ()
...
@implementation XDPhotoBrowserLoading
...
+ (UILabel *)showText:(NSString *)text toView:(UIView *)superView dismissAfterSecond:(NSTimeInterval)second {
    ...
    UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0,XDScreenWidth - 40, 40)];
    textLabel.text = text;
